<!-- Space: Projects -->
<!-- Parent: ZshGhq -->
<!-- Title: Contributing GithubFlow ZshGhq -->
<!-- Label: ZshGhq -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-ghq project on [GitHub](https://github.com/hadenlabs/zsh-ghq), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-ghq/pulls).
...
To follow the instructions in this guide and start contributing to zsh-ghq project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-ghq.git
```

Now your **upstream** points to **hadenlabs/zsh-ghq**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-ghq
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-ghq/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
